...
import { CONTROLLER_ENUM, DIRECTION_ENUM, ENTITY_STATE_ENUM, PARAMS_NAME_ENUM, SHAKE_TYPE_ENUM } from '../../Enum'
...
/** 操作 to 振动方向映射 */
export const CONTROLLER_TO_SHAKE_TYPE_ENUM_MAP = {
  [CONTROLLER_ENUM.TOP]: {
    [DIRECTION_ENUM.TOP]: SHAKE_TYPE_ENUM.TOP,
    [DIRECTION_ENUM.BOTTOM]: SHAKE_TYPE_ENUM.TOP,
    [DIRECTION_ENUM.LEFT]: SHAKE_TYPE_ENUM.TOP,
    [DIRECTION_ENUM.RIGHT]: SHAKE_TYPE_ENUM.TOP,
  },
  [CONTROLLER_ENUM.BOTTOM]: {
    [DIRECTION_ENUM.TOP]: SHAKE_TYPE_ENUM.BOTTOM,
    [DIRECTION_ENUM.BOTTOM]: SHAKE_TYPE_ENUM.BOTTOM,
    [DIRECTION_ENUM.LEFT]: SHAKE_TYPE_ENUM.BOTTOM,
    [DIRECTION_ENUM.RIGHT]: SHAKE_TYPE_ENUM.BOTTOM,
  },
  [CONTROLLER_ENUM.LEFT]: {
    [DIRECTION_ENUM.TOP]: SHAKE_TYPE_ENUM.LEFT,
    [DIRECTION_ENUM.BOTTOM]: SHAKE_TYPE_ENUM.LEFT,
    [DIRECTION_ENUM.LEFT]: SHAKE_TYPE_ENUM.LEFT,
    [DIRECTION_ENUM.RIGHT]: SHAKE_TYPE_ENUM.LEFT,
  },
  [CONTROLLER_ENUM.RIGHT]: {
    [DIRECTION_ENUM.TOP]: SHAKE_TYPE_ENUM.RIGHT,
    [DIRECTION_ENUM.BOTTOM]: SHAKE_TYPE_ENUM.RIGHT,
    [DIRECTION_ENUM.LEFT]: SHAKE_TYPE_ENUM.RIGHT,
    [DIRECTION_ENUM.RIGHT]: SHAKE_TYPE_ENUM.RIGHT,
  },
  [CONTROLLER_ENUM.TURNLEFT]: {
    [DIRECTION_ENUM.TOP]: SHAKE_TYPE_ENUM.LEFT,
    [DIRECTION_ENUM.BOTTOM]: SHAKE_TYPE_ENUM.RIGHT,
